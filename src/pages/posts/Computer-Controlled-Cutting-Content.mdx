...
**Vinyl Design:**
Inspired by artist Lexie Liu's song 'Fortuna', I designed the following on Inkscape, a vector graphics editor.  

![Fortuna Design](/classes/863.24/people/RobinLiu/images/fortuna.svg)  

![Fortuna Sketch](/classes/863.24/people/RobinLiu/images/fortuna_draw.JPG)  
Inkscape lets you convert images into bitmaps where you can easily modify the vectors!  

![Vector Path](/classes/863.24/people/RobinLiu/images/vector_path.JPG)  
Prepping for cutting - showing the path of the cutter.  
ADD VIDEO HERE!!  

![Transfer Paper](/classes/863.24/people/RobinLiu/images/transfer.JPG)  
Using transfer paper (oops).  

![Sticker](/classes/863.24/people/RobinLiu/images/sticker.JPG)  
On my computer!  
